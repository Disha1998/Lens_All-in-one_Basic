...
import { comment, signCreateCommentTypedData } from './comment-type-data';
...
export const DoComment = async (cmntData) => {
    ...
    const result = await signCreateCommentTypedData(createCommentRequests);
...
export const commentGasless = async (postData) => {
